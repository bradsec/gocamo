...
// MulticamGenerator creates multicam (Scattered Camouflage) patterns.
// Uses multi-scale organic and digital structures.
type MulticamGenerator struct{}

// Generate creates multicam style camouflage inspired by real military field patterns.
// Uses multi-scale approach with organic blob shapes and digital pixel structure.
func (pg *MulticamGenerator) Generate(ctx context.Context, cfg *config.Config, colors []color.RGBA) (image.Image, error) {
...
func (pg *MulticamGenerator) generateLargeScaleBlobs(grid [][]int, gridWidth, gridHeight int, colors []color.RGBA, cfg *config.Config) {
...
func (pg *MulticamGenerator) generateMediumScaleElements(grid [][]int, gridWidth, gridHeight int, colors []color.RGBA, cfg *config.Config) {
...
func (pg *MulticamGenerator) generateSmallScaleNoise(grid [][]int, gridWidth, gridHeight int, colors []color.RGBA, cfg *config.Config) {
...
func (pg *MulticamGenerator) addFractalDetails(grid [][]int, gridWidth, gridHeight int, colors []color.RGBA, cfg *config.Config) {
...
func (pg *MulticamGenerator) drawOrganicBlob(grid [][]int, centerX, centerY, size, colorIndex, gridWidth, gridHeight int) {
...
func (pg *MulticamGenerator) drawFractalElement(grid [][]int, centerX, centerY, size, colorIndex, gridWidth, gridHeight int) {
...
func (pg *MulticamGenerator) simpleNoise(x, y float64) float64 {
...
func (pg *MulticamGenerator) drawEllipticalBlob(grid [][]int, centerX, centerY, sizeX, sizeY, colorIndex, gridWidth, gridHeight int) {
...
func (pg *MulticamGenerator) addColorTransitions(grid [][]int, gridWidth, gridHeight int, colors []color.RGBA, cfg *config.Config) {
...
func (pg *MulticamGenerator) addDirectionalFlow(grid [][]int, gridWidth, gridHeight int, colors []color.RGBA, cfg *config.Config) {
...
func (pg *MulticamGenerator) blendTransitions(grid [][]int, gridWidth, gridHeight int, colors []color.RGBA, cfg *config.Config) {
...
func (pg *MulticamGenerator) getIntermediateColor(color1, color2, numColors int) int {
...
func (pg *MulticamGenerator) drawSoftAngularElement(grid [][]int, centerX, centerY, size, colorIndex, gridWidth, gridHeight int) {
...
func (pg *MulticamGenerator) drawTinyOrganicCluster(grid [][]int, centerX, centerY, size, colorIndex, gridWidth, gridHeight int) {
