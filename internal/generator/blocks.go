...
// BlocksGenerator creates blocks (geometric box-style) camouflage patterns with squares and rectangles.
...
// Generate creates a blocks-style camouflage pattern with geometric shapes, squares, and rectangles.
// It uses cellular automata to create clustered regions and adds larger geometric shapes for variation.
func (pg *BlocksGenerator) Generate(ctx context.Context, cfg *config.Config, colors []color.RGBA) (image.Image, error) {
