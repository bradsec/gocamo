...
// BlobGenerator creates blob (organic blob-like) camouflage patterns using cellular automata.
// It generates clustered regions of colors that resemble natural camouflage patterns.
type BlobGenerator struct{}

// Generate creates a blob-style camouflage pattern using cellular automata to create
// organic, clustered regions of colors that mimic natural camouflage patterns.
func (pg *BlobGenerator) Generate(ctx context.Context, cfg *config.Config, colors []color.RGBA) (image.Image, error) {
