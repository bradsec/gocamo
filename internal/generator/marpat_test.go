...
func TestMarpatGenerator_Generate(t *testing.T) {
...
func TestMarpatGenerator_DefaultColorRatios(t *testing.T) {
	gen := &MarpatGenerator{}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ratios := gen.getMarpatDefaultColorRatios(tt.numColors)
...
func TestMarpatGenerator_InitializeMarpatGrid(t *testing.T) {
	gen := &MarpatGenerator{}
	width, height := 10, 10
	numColors := 4
...
func TestMarpatGenerator_RectangularCA(t *testing.T) {
	gen := &MarpatGenerator{}
	width, height := 20, 20
	numColors := 4
...
func TestMarpatGenerator_WithCustomColorRatios(t *testing.T) {
	ctx := context.Background()
	cfg := &config.Config{
		Width:         50,
		Height:        50,
...
func TestMarpatGenerator_EdgeCases(t *testing.T) {
	gen := &MarpatGenerator{}
	ctx := context.Background()
...
func TestMarpatGenerator_DefaultRatios(t *testing.T) {
	// When no explicit ratios are set (RatiosString == ""), marpat must use its
