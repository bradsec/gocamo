...
// PatternTypes lists the canonical generator names in their conventional order.
var PatternTypes = []string{"woodland", "multicam", "blocks", "blob", "marpat", "fleck"}
...
func ParseFlags() *Config {
	...
	flag.StringVar(&cfg.PatternType, "t", "woodland", "Set the pattern type (woodland, multicam, blocks, blob, marpat, fleck, all, or image)")
